...
export default function LanguageToggle({ i18n }: LanguageToggleProps) {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center justify-center w-14 h-10 rounded-lg border border-neutral-200 dark:border-[rgba(255,46,209,0.24)] bg-background dark:bg-neutral-800">
