...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    return (
        ...
        >
            {/* Profile Image */}
            <div className="w-64 h-64 mx-auto mb-6 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl dark:hover:shadow-[0_0_24px_rgba(255,46,209,0.16)] transition-all duration-200 hover:scale-105">
                <Image
                    src={author.avatar}
                    alt={author.name}
                    width={256}
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4 mb-6 hover:shadow-lg dark:hover:shadow-[0_0_0_1px_rgba(255,46,209,0.28),0_0_18px_rgba(255,46,209,0.14)] transition-all duration-200 hover:scale-[1.02]">
